...
const infoData = [
  ...
  },
  {
    ...
    text: "+62 888 202 3920",
  },
  {
    icon: <MailIcon size={20} />,
    text: "alam.nurzaman17@gmail.com",
  },
  {
    icon: <Calendar size={20} />,
    text: "Born on 17 Jul, 2001",
  },
  {
...
const qualificationData = [
  {
    ...
    data: [
      ...
      },
      {
        ...
        qualification: "Rekayasa Perangkat Lunak",
        years: "2016 - 2019",
      },
    ],
  },
        ...
        <div className="flex flex-col xl:flex-row">
          ...
          <div className="flex-1">
            <Tabs defaultValue="personal">
              <TabsList className="w-full grid xl:grid-cols-3 xl:max-[520px] xl:border dark:border-none">
